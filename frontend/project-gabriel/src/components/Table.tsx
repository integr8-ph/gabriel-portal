                                ...
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                        <tr>
                                            ...
                                            <th scope="col" className="px-4 py-3">Super user</th>
                                    ...
                                    <tbody>
                                        {dummyData.map((item, index) => (
                                            <tr key={index} className="border-b dark:border-gray-700">
                                                ...
                                                <td className="px-4 py-3 max-w-[12rem] truncate">{item.is_active ? 'Yes' : 'No'}</td>
                                                ...
                                                <td className="px-4 py-3 flex items-center justify-end relative">
                                                    ...
                                                    {/* <div
                                                        id="dropdown"
                                                        className={`z-50 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 ${isDropdownOpen ? '' : 'hidden'}`} >
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-full">
                        ...
                        <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <div className="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                                ...
                                <button type="button" onClick={handleToggleModal} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-target="createUserModal" data-modal-toggle="createUserModal">
